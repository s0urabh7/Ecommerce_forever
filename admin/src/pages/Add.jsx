  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full gap-3 items-start'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} type="text" placeholder='Write product content here' required className='w-full max-w-[500px] px-3 py-2' />
      </div>
